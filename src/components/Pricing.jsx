              ...
              <ul>
                {option.features.map((feature, index) => (
                  <li key={index} className="flex items-center mt-8">
                    <CheckCircle2 />
                    <span className="ml-2z ">{feature}</span>
                  </li>
                ))}
              </ul>
              <a
                href="#"
                className="inline-flex items-center justify-center w-full h-12 p-5 mt-20 text-xl tracking-tight text-center transition border border-orange-900 rounded-lg hover:bg-orange-900"
              >
                Subscribe
              </a>
            </div>
