  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-4xl tracking-wide text-center sm:text-6xl lg:text-7xl">
        ...
        <span className="font-medium text-transparent bg-gradient-to-r from-orange-500 to-red-800 bg-clip-text">
          for developers
        </span>
      </h1>
      <p className="mt-10 text-lg text-center text-clip text-neutral-500">
